...
This code is written in Jax based on the Jax implementation of NeRF (Jax-NeRF). Please find the link for the [Jax-NeRF](https://github.com/google-research/google-research/tree/master/jaxnerf) here. This code is created and maintained by [Dharmendra Selvaratnam](https://github.com/Dharmendra04?tab=repositories) & [Dr Dena Bazazian](https://denabazazian.github.io/)
